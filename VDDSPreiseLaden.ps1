...
class KZVen {
    ...
    KZVen () {
        ...
        $this.KZV[1] = [KZV]::new('Bayern', 'Baye', '11', 'https://www.kzvb.de/', 'https://www.kzvb.de/abrechnung/bel-preise', 'https://www.kzvb.de/fileadmin/user_upload/Abrechnung/BEL/11la0125.csv', 'https://www.kzvb.de/fileadmin/user_upload/Abrechnung/BEL/BEL-Preise_ZE_2025.pdf')
        ...
        $this.KZV[4] = [KZV]::new('Bremen', 'Brem', '31', 'https://www.kzv-bremen.de/', 'https://www.kzv-bremen.de/praxis/abrechnung/bel', 'https://www.kzv-bremen.de/praxis/abrechnung/files/31la0124.csv', 'https://www.kzv-bremen.de/praxis/files/21_zahntechnikvertraege.pdf')
        ...
        $this.KZV[11] = [KZV]::new('Rheinland-Pfalz', 'RhPf', '06', 'https://www.kzvrlp.de/', 'https://www.kzvrlp.de/mitglieder/abrechnung/bel-ii/', 'https://www.kzvrlp.de/securedl/sdl-eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpYXQiOjE3MzI4ODM5OTIsImV4cCI6MTczMjk3Mzk5MiwidXNlciI6MCwiZ3JvdXBzIjpbMCwtMV0sImZpbGUiOiJcL2ZpbGVhZG1pblwvS1pWXC9Eb3dubG9hZHNcL01pdGdsaWVkZXJcL0FicmVjaG51bmdcL0FrdHVlbGxlc1wvQkVMLVByZWlzZVwvMDZsYTAxMjQuY3N2IiwicGFnZSI6MzIyfQ.JDoqeRJN6d6xjUewMd1UsO84WnLWpa58tZlcECzNc3U/06la0124.csv', 'https://www.kzvrlp.de/securedl/sdl-eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..zXlh6m0HSI9HsJRI3PsS6G1xgMbeeDRkKUiK8Ygx-Yg/Kurzfassung_BEL_Preise_01.01.2024-31.12.2024_.pdf')
        $this.KZV[12] = [KZV]::new('Saarland'
	                           ,'Saar', '35', 'https://www.kzv-saarland.de/'
			    	   ,'https://www.kzv-saarland.de/praxen/abrechnung/zahntechnik-bel'
	                           ,'https://www.kzv-saarland.de/api/view/9b917a0c-9c2b-4f17-a008-4296c7d43da8'		# CSV
			           ,'https://www.kzv-saarland.de/api/view/9bc3a958-8b74-48d8-87fe-f11722fa0e42')	# PDF
